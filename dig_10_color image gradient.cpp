...
int main()
{
	...
	//FillColor(Image, 40, 50, W, H, 0, 0, 255);


	/*
	for (int i = 0; i < W; i++)
	{
		FillColor(Image, i, 200, W, H, 0, 0, 255);
	}
	*/
	...
	for (int a = 0; a < 160; a++)
	{
		...
		{
			wt = i / (double)(W - 1);
			Image[a * W * 3 + i * 3] = (BYTE)(255 * (1.0 - wt)); //B
			Image[a * W * 3 + i * 3 + 1] = (BYTE)(255 * wt); //GREEN
			Image[a * W * 3 + i * 3 + 2] = (BYTE)(255 * wt); //R
		}
	...
	for (int a = 320; a < 480; a++)
	{
		for (int i = 0; i < W; i++)
		{
			...
			Image[a * W * 3 + i * 3] = (BYTE)(255 * wt); //B
			Image[a * W * 3 + i * 3 + 1] = (BYTE)(255 * wt); //GREEN
			Image[a * W * 3 + i * 3 + 2] = (BYTE)(255 * (1.0 - wt)); //R
		}
